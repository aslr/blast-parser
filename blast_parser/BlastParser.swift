...
extension BlastParser {
	...
	struct MergeQiime: ParsableCommand {
        ...
        @Option(name: [.short, .customLong("prefixes")],
                help: "Prefix(es) to add to the Qiime ASV taxonomic assignment headers separated by spaces to distinguish between different classifiers or databases. [OPTIONAL, default = parent directory name of the directory where the asv file is located, i.e., 2 levels up.]")
        var prefixes:String?
